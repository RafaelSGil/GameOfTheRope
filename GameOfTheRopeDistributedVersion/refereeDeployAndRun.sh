...
sshpass -f password ssh sd103@l040101-ws09.ua.pt 'cd test/GameOfTheRope/dirReferee ; java clientSide.main.ClientGameOfTheRopeReferee l040101-ws01.ua.pt 22121 l040101-ws02.ua.pt 22122 l040101-ws06.ua.pt 22126 l040101-ws05.ua.pt 22125 log'