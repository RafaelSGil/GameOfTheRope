...
public class ServerGameOfTheRopeContestantsBench {
    ...
    public static void main (String [] args){
        ContestantsBench contestantsBench;                             // playground (service to be rendered)
        ContestantBenchInterface contestantBenchInterface;             // interface to the playground
        ...
        contestantsBench = new ContestantsBench(generalRepositoryStub);                           // service is instantiated
        contestantBenchInterface = new ContestantBenchInterface(contestantsBench);                // interface for the service is instantiated
        ...
        ContestantBenchProxy contestantBenchProxy;

        waitConnection = true;
        while (waitConnection){
            try{
                sconi = scon.accept ();                                                                     // enter listening procedure
                contestantBenchProxy = new ContestantBenchProxy (sconi, contestantBenchInterface);          // start a service provider agent to address
                contestantBenchProxy.start ();                                                              //   the request of service
