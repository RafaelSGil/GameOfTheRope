...
public class ServerGameOfTheRopePlayground {
    ...
    public static void main(String[] args) {
        ...
        playground = new Playground(generalRepositoryStub);                                       // service is instantiated
        playgroundInterface = new PlaygroundInterface(playground);                                // interface for the service is instantiated
        ...
        while (waitConnection) {
            try {
                ...
                playgroundProxy = new PlaygroundProxy(sconi, playgroundInterface);         // start a service provider agent to address
                playgroundProxy.start();                                                   //   the request of service
